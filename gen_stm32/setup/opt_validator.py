...
Info
    Validator for the gen_stm32 bundle options.
'''
...
class GenSTM32BundleOptionsValidator:
    '''
        Validator for the gen_stm32 bundle options.
    ...
    @classmethod
    def validate(cls, options: GenSTM32BundleOptions) -> None:
        '''
            Validates the gen_stm32 bundle options.

            :param options: The gen_stm32 bundle options to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_stm32_bundle_options_validator::validate(...)'
        msg_options_none: str = 'the gen_stm32 bundle options must be provided'
        msg_options_istype: str = 'the gen_stm32 bundle options must be a Mapping'

        not_none(options, ctx, msg_options_none)
        istype(options, Mapping, ctx, msg_options_istype)

        for attr_name, expected_type in GenSTM32BundleKeys.get_option_to_type().items():
