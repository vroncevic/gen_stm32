 ...
 * stm32f4xx_rcc.h
 * 
 * This file contains all the functions prototypes for RCC firmware library.
 * 
 * Version V1.0.0
 ...
 *
 * stm32f4xx_rcc is distributed in the hope that it will be useful, but
