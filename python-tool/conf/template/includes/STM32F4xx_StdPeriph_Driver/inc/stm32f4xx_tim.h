 ...
 * stm32f4xx_tim.h
 * 
 * This file contains all functions prototypes for TIM firmware library.
 * 
 * Version V1.0.0
 ...
 *
 * stm32f4xx_tim is distributed in the hope that it will be useful, but
...
typedef struct {
    uint16_t TIM_Prescaler; /* Specifies prescaler value used to divide
                               TIM clock. Parameter can be a number between
                               0x0000 and 0xFFFF */
    uint16_t TIM_CounterMode; /* Specifies counter mode. Parameter can be
                                 value of TIM_Counter_Mode */
    uint32_t TIM_Period; /* Specifies period value to be loaded into active
                            Auto-Reload Register at next update event.
                            Parameter must be a number between 0x0000 and
                            0xFFFF. */
    uint16_t TIM_ClockDivision; /* Specifies clock division. Parameter can be
                                   value of TIM_Clock_Division_CKD */
    uint8_t TIM_RepetitionCounter; /* Specifies repetition counter value.
                                      Each time RCR downcounter reaches zero,
                                      an update event is generated and
                                      counting restarts from RCR value (N).
                                      This means in PWM mode that (N+1)
                                      corresponds to:
                                        - number of PWM periods in edge-aligned
                                          mode
                                        - number of half PWM period in
                                          center-aligned mode
                                      Parameter must be a number between 0x00
                                      and 0xFF. This parameter is valid only
                                      for TIM1 and TIM8. */
} TIM_TimeBaseInitTypeDef;

typedef struct {
    uint16_t TIM_OCMode; /* Specifies TIM mode. This parameter can be a value
                            of TIM_Output_Compare_and_PWM_modes */
    uint16_t TIM_OutputState; /* Specifies TIM Output Compare state. This
                                 parameter can be a value of
                                 TIM_Output_Compare_State */
    uint16_t TIM_OutputNState; /* Specifies TIM complementary Output Compare
                                  state. This parameter can be a value of
                                  TIM_Output_Compare_N_State. This parameter
                                  is valid only for TIM1 and TIM8. */
    uint32_t TIM_Pulse; /* Specifies pulse value to be loaded into Capture
                           Compare Register. This parameter can be a number
                           between 0x0000 and 0xFFFF */
    uint16_t TIM_OCPolarity; /* Specifies output polarity. This parameter can
                                be a value of TIM_Output_Compare_Polarity */
    uint16_t TIM_OCNPolarity; /* Specifies complementary output polarity.
                                 This parameter can be a value of
                                 TIM_Output_Compare_N_Polarity. This parameter
                                 is valid only for TIM1 and TIM8. */
    uint16_t TIM_OCIdleState; /* Specifies TIM Output Compare pin state during
                                 Idle state. This parameter can be a value of
                                 TIM_Output_Compare_Idle_State. This parameter
                                 is valid only for TIM1 and TIM8. */
    uint16_t TIM_OCNIdleState; /* Specifies TIM Output Compare pin state
                                  during Idle state. This parameter can be a
                                  value of TIM_Output_Compare_N_Idle_State
                                  This parameter is valid only for TIM1 and
                                  TIM8. */
} TIM_OCInitTypeDef;

typedef struct {
    uint16_t TIM_Channel; /* Specifies TIM channel. This parameter can be a
                             value of TIM_Channel */
    uint16_t TIM_ICPolarity; /* Specifies active edge of input signal.
                                This parameter can be a value of
                                TIM_Input_Capture_Polarity */
    uint16_t TIM_ICSelection; /* Specifies input. This parameter can be a
                                 value of TIM_Input_Capture_Selection */
    uint16_t TIM_ICPrescaler; /* Specifies Input Capture Prescaler. This
                                 parameter can be a value of
                                 TIM_Input_Capture_Prescaler */
    uint16_t TIM_ICFilter; /* Specifies input capture filter. This parameter
                              can be a number between 0x0 and 0xF */
} TIM_ICInitTypeDef;

typedef struct {
    uint16_t TIM_OSSRState; /* Specifies Off-State selection used in Run mode.
                               This parameter can be a value of
                            TIM_OSSR_Off_State_Selection_for_Run_mode_state */
    uint16_t TIM_OSSIState; /* Specifies Off-State used in Idle state.
                               This parameter can be a value of
                            TIM_OSSI_Off_State_Selection_for_Idle_mode_state */
    uint16_t TIM_LOCKLevel; /* Specifies LOCK level parameters. This parameter
                               can be a value of TIM_Lock_level */
    uint16_t TIM_DeadTime; /* Specifies delay time between switching-off
                              and the switching-on of outputs. This parameter
                              can be a number between 0x00 and 0xFF */
    uint16_t TIM_Break; /* Specifies whether TIM Break input is enabled or not.
                           This parameter can be a value of
                           TIM_Break_Input_enable_disable */
    uint16_t TIM_BreakPolarity; /* Specifies TIM Break Input pin polarity.
                                   This parameter can be a value of
                                   TIM_Break_Polarity */
    uint16_t TIM_AutomaticOutput; /* Specifies whether TIM Automatic Output
                                     feature is enabled or not. This parameter
                                     can be a value of TIM_AOE_Bit_Set_Reset */
} TIM_BDTRInitTypeDef;

#define IS_TIM_ALL_PERIPH(PERIPH) ( \
    ((PERIPH) == TIM1) || ((PERIPH) == TIM2) || \
    ((PERIPH) == TIM3) || ((PERIPH) == TIM4) || \
    ((PERIPH) == TIM5) || ((PERIPH) == TIM6) || \
    ((PERIPH) == TIM7) || ((PERIPH) == TIM8) || \
    ((PERIPH) == TIM9) || ((PERIPH) == TIM10) || \
    ((PERIPH) == TIM11) || ((PERIPH) == TIM12) || \
...
#define IS_TIM_IC_PRESCALER(PRESCALER) (((PRESCALER) == TIM_ICPSC_DIV1) || \
    ((PRESCALER) == TIM_ICPSC_DIV2) || ((PRESCALER) == TIM_ICPSC_DIV4) || \
