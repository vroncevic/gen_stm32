 ...
 *                     Multiplier and Divider factors, AHB/APBx prescalers and
 *                     Flash settings), depending on the configuration made in
 *                     the clock xls tool. This function is called at startup
 *                     just after reset and before branch to main program.
 ...
 * mounted on STM324xG_EVAL board as data memory.
 */
/* #define DATA_IN_ExtSRAM */

/**
 * Uncomment the following line if you need to relocate your
 * vector Table in Internal SRAM.
 */
...
/**
 * Setup the external memory controller. Called in startup_stm32f4xx.s
